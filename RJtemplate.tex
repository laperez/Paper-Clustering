...
\section{The \pkg{Clustering} package}\label{sec:clusteringpackage}
...
We already have the best variables for each execution, we also have methods to group the measures of dissimilarity from the algorithms.
